...
public class AnimalFactoryImpl implements AnimalFactory{
    @Override
    public Animal createAnimal(String breed, String name, Double cost, String character, LocalDate birthDate) {
    ...
    public List<Animal> createAnimalList(int N, String breed, String name, Double cost, String character, LocalDate birthDate) {
        ...
        for (int i = 0; i < N; i++) {
            newAnimalList.add(createAnimal(breed, name, cost, character, birthDate));
        }
    ...
    public List<Animal> createAnimalListWithRandomDates(int N, String breed, String name, Double cost, String character) {
        ...
        for (int i = 0; i < N; i++) {
            newAnimalList.add(createAnimal(breed, name, cost, character, rnd.createRandomDate()));
        }
